  ...
  return (
    <DefaultLayout>
      <div className="container mx-auto flex justify-center items-center p-[20px] xl:p-[70px]">
          ...
          <div className="flex w-5/12 rounded-lg flex-col items-center justify-center space-y-5 ">
            ...
            <div className="flex flex-col rounded-lg border border-white border-2 p-7 w-full space-y-5  dark:bg-[#F9838F33]">
              ...
              <div className="flex flex-col w-full space-y-2 relative">                
                ...
                <button className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 dark:text-black p-2 rounded-full bg-[#FF91A4] items-center justify-center w-12 h-12">
                  <FontAwesomeIcon icon={faRightLeft} className="text-white  rotate-90 stroke-effect text-[20px] dark:text-black"/>
                </button>
                <button className="flex bg-white rounded-md p-5 bg-opacity-70 items-center justify-start space-x-3 dark:bg-[#2F0607] dark:text-white dark:bg-opacity-50" onClick={selectToken}>
                    <Image 
        ...
        <Confirm isOpen={isSwap} onClose={closeSwap} />
