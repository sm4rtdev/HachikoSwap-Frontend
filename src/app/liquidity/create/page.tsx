    ...
    <div className="container mx-auto flex justify-center items-center p-[20px] xl:px-[100px] py-8">
      <div className="flex w-full justify-center items-start space-x-8 w-full">
        <div className="flex w-7/12 flex-col items-center justify-center space-y-6">            
          <div className="flex flex-col rounded-lg border border-white border-2 p-10 py-7 w-full dark:bg-[#5D2B32]">
        ...
        <div className="flex w-5/12 rounded-lg flex-col items-center justify-center">            
          <div className="flex flex-col rounded-t-lg border border-white border-2 p-7 py-10 w-full relative dark:bg-[#5D2B32]">
              ...
              <div className="flex space-x-1">
                ...
                <div className="flex items-center">
                  <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      />
                      <div className="w-7 h-3.5 bg-gray-200 border border-[#684222] rounded-full shadow-inner dark:bg-[#5D2B32] dark:border border-[#C37623]"></div><p className="text-black font-normal text-14 pl-1 leading-[19.07px] dark:text-white">CL</p>
                      <div
                          className={`absolute w-2.5 h-2.5 rounded-full shadow transform transition-transform duration-300 ease-in-out ${
                              isChecked ? 'translate-x-3.5 bg-[#684222] dark:bg-[#C37623]' : 'translate-x-1 bg-[#684222] dark:bg-[#C37623]'
                          }`}
                      ></div>
                  </label>
                </div>
