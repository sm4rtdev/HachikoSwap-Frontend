...
const Header: React.FC = () => {
    ...
    return (
        <div className='w-full h-[170px] flex flex-col  items-center justify-start container mx-auto'>
            <div className='w-full h-[73px] rounded-b-[34px] rounded-t-none bg-[#FF7D82] px-10 flex items-center justify-center justify-between dark:bg-[#FF8693]'>
            ...
            <div className='w-full h-[97px] flex items-center justify-center justify-between px-10'>
