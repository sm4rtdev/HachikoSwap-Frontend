...
import { faAngleDown, faAward, faWarning } from '@fortawesome/free-solid-svg-icons';
import { faCodeFork } from '@fortawesome/free-solid-svg-icons';
const Merge: React.FC<{  seletToken: () => void }> = ({seletToken}) => {
    return (
        <div className="flex flex-col w-full space-y-2 relative">     
            ...
            <button className="flex flex-col bg-white rounded-md p-5 bg-opacity-70 items-center bg-opacity-50 space-y-2 dark:bg-[#4A1F27] dark:bg-opacity-50"  onClick={seletToken}>
            ...
            <button className="absolute top-2/3 left-1/2 transform -translate-x-1/2 -translate-y-1/3 -translate-y-8 ">
                <div className='flex rounded-full p-2 items-center justify-center bg-custom-gradient w-10 h-10'>
                <FontAwesomeIcon icon={faCodeFork} className="text-white text-[26px] rotate-180 dark:text-[#4A1F27]"/>
                </div>                
            </button>
            <div className="flex bg-white rounded-md p-5 bg-opacity-70 items-center justify-start space-x-3 dark:bg-[#4A1F27] dark:bg-opacity-50">
                <div className="flex space-x-4 items-center">
                    ...
                    <div className="flex flex-col">
                        <div className="flex space-x-2 items-center">
                            <p className="font-sans text-[16px] font-[400] leading-[20.48px] text-black dark:text-white">
                                Select a veHACHI 
                            </p>        
